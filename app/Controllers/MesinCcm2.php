...
class MesinCcm2 extends BaseController
{
    private const INDEX_ROUTE = '/gudang/mesin_ccm2';
    private const VIEW_PATH = 'gudang/mesinccm2';

    protected $MMesin;

    public function __construct()
    {
        $this->MMesin = new MMesinCcm2();
        helper(['form', 'url']);
    }
    ...
    public function tambahData()
    {
        ...
        if ($this->MMesin->insert($data)) {
            session()->setFlashdata('success', 'Data mesin ccm2 berhasil ditambahkan');
        } else {
    ...
    public function update($id = null)
    {
        ...
        if ($this->MMesin->update($id, $data)) {
            session()->setFlashdata('success', 'Data mesin ccm2 berhasil diupdate');
        } else {
