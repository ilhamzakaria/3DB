...
class MesinPowerjet1 extends BaseController
{
    private const INDEX_ROUTE = '/gudang/mesin_powerjet1';
    private const VIEW_PATH = 'gudang/mesinpowerjet1';

    protected $MMesin;

    public function __construct()
    {
        $this->MMesin = new MMesinPowerjet1();
        helper(['form', 'url']);
    }
    ...
    public function tambahData()
    {
        ...
        if ($this->MMesin->insert($data)) {
            session()->setFlashdata('success', 'Data mesin powerjet1 berhasil ditambahkan');
        } else {
    ...
    public function update($id = null)
    {
        ...
        if ($this->MMesin->update($id, $data)) {
            session()->setFlashdata('success', 'Data mesin powerjet1 berhasil diupdate');
        } else {
