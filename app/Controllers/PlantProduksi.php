...
class PlantProduksi extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = [
            'title' => 'Plant Produksi',
            'produksi' => $query->orderBy('tanggal', 'DESC')->orderBy('shift', 'DESC')->findAll(),
            'spk_list' => $this->getSpkList(),
            'q' => $q,
            'filter_shift' => $shift,
            'filter_tanggal' => $tanggal
        ];
        return view('plant_produksi/index', $data);
    }
    ...
    public function tambah()
    {
        ...
        return view('plant_produksi/tambah', $data);
    }
    ...
    public function simpan()
    {
        ...
        return redirect()->to('/plant_produksi')->with('success', 'Data produksi berhasil disimpan.');
    }
    ...
    public function edit($id)
    {
        ...
        if (!$header) {
            return redirect()->to('/plant_produksi')->with('error', 'Data tidak ditemukan.');
        }
        ...
        return view('plant_produksi/edit', $data);
    }
    ...
    public function update($id)
    {
        ...
        return redirect()->to('/plant_produksi')->with('success', 'Data produksi berhasil diperbarui.');
    }

    public function delete($id)
    {
        $this->headerModel->delete($id);
        return redirect()->to('/plant_produksi')->with('success', 'Data dipindahkan ke tempat sampah.');
    }
    ...
    public function trash()
    {
        ...
        return view('plant_produksi/trash', $data);
    }
    ...
    public function restore($id)
    {
        ...
        return redirect()->to('/plant_produksi/trash')->with('success', 'Data berhasil dipulihkan.');
    }
    ...
    public function deletePermanent($id)
    {
        ...
        return redirect()->to('/plant_produksi/trash')->with('success', 'Data berhasil dihapus permanen.');
    }
    ...
    public function get_last_data($spk)
    {
        ...
        if ($lastHeader) {
            ...
            $legacyData = db_connect()->table('prod')->where('no_spk', $spk)->orderBy('id', 'DESC')->get()->getRowArray();
    ...
    {
        // Get unique SPKs from new production headers
        $newSpks = $this->headerModel->select('nomor_spk as no_spk, nama_mesin, nama_produksi as nama_produk')
                                    ->groupBy('nomor_spk')
                                    ->findAll();
                                    
        // Get unique SPKs from legacy production table
        $legacySpks = db_connect()->table('prod')
