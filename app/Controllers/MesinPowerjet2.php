...
class MesinPowerjet2 extends BaseController
{
    private const INDEX_ROUTE = '/gudang/mesin_powerjet2';
    private const VIEW_PATH = 'gudang/mesinpowerjet2';

    protected $MMesin;

    public function __construct()
    {
        $this->MMesin = new MMesinPowerjet2();
        helper(['form', 'url']);
    }
    ...
    public function tambahData()
    {
        ...
        if ($this->MMesin->insert($data)) {
            session()->setFlashdata('success', 'Data mesin powerjet2 berhasil ditambahkan');
        } else {
    ...
    public function update($id = null)
    {
        ...
        if ($this->MMesin->update($id, $data)) {
            session()->setFlashdata('success', 'Data mesin powerjet2 berhasil diupdate');
        } else {
