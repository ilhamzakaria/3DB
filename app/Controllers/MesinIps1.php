...
class MesinIps1 extends BaseController
{
    private const INDEX_ROUTE = '/gudang/mesin_ips1';
    private const VIEW_PATH = 'gudang/mesinips1';

    protected $MMesin;

    public function __construct()
    {
        $this->MMesin = new MMesinIps1();
        helper(['form', 'url']);
    }
    ...
    public function tambahData()
    {
        ...
        if ($this->MMesin->insert($data)) {
            session()->setFlashdata('success', 'Data mesin ips1 berhasil ditambahkan');
        } else {
    ...
    public function update($id = null)
    {
        ...
        if ($this->MMesin->update($id, $data)) {
            session()->setFlashdata('success', 'Data mesin ips1 berhasil diupdate');
        } else {
