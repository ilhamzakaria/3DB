...
class MesinIps3 extends BaseController
{
    private const INDEX_ROUTE = '/gudang/mesin_ips3';
    private const VIEW_PATH = 'gudang/mesinips3';

    protected $MMesin;

    public function __construct()
    {
        $this->MMesin = new MMesinIps3();
        helper(['form', 'url']);
    }
    ...
    public function tambahData()
    {
        ...
        if ($this->MMesin->insert($data)) {
            session()->setFlashdata('success', 'Data mesin ips3 berhasil ditambahkan');
        } else {
    ...
    public function update($id = null)
    {
        ...
        if ($this->MMesin->update($id, $data)) {
            session()->setFlashdata('success', 'Data mesin ips3 berhasil diupdate');
        } else {
