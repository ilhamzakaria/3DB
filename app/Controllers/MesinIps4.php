...
class MesinIps4 extends BaseController
{
    private const INDEX_ROUTE = '/gudang/mesin_ips4';
    private const VIEW_PATH = 'gudang/mesinips4';

    protected $MMesin;

    public function __construct()
    {
        $this->MMesin = new MMesinIps4();
        helper(['form', 'url']);
    }
    ...
    public function tambahData()
    {
        ...
        if ($this->MMesin->insert($data)) {
            session()->setFlashdata('success', 'Data mesin ips4 berhasil ditambahkan');
        } else {
    ...
    public function update($id = null)
    {
        ...
        if ($this->MMesin->update($id, $data)) {
            session()->setFlashdata('success', 'Data mesin ips4 berhasil diupdate');
        } else {
